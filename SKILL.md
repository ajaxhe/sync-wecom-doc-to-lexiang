...
> 🔴 **三条职责原则（2026-09-22 用户裁决，skill 的最高纲领，review 时逐条对照）**：
...
>    （历史教训：曾把 `video_content_empty` 分档为「已导入·内容提示」并 exit 0，2026-09-22 晚裁决**整体删除**——
>    skill 不得替服务端解释「这个失败其实算成功」，详见 `references/pitfalls.md` §2.11。）
